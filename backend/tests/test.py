...
class TestPartnerStateView(APITestCase):
    ...
    def setUp(self):
        ...
        self.shop_user = User.objects.create_user(first_name='first_shop', last_name='last_shop',
    ...
    def test_get_partner_state_authenticated_shop_user(self):
        ...
        self.assertEqual(response.json(),
                         {'id': self.shop.id, 'name': 'Test Shop', 'user_id': self.shop.user_id, 'state': True})
    ...
    def test_get_partner_state_authenticated_second_shop_user(self):
        ...
        second_shop_user = User.objects.create_user(first_name='second_shop_user', last_name='second_shop',
                                                    email='shop_second.gmail.com',
                                                    password='password', company='company', position='position',
                                                    type='customer')
